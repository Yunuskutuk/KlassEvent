 ...
 */
final class Version20210127131022 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE contact (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, sender_email VARCHAR(50) NOT NULL, receiver_email VARCHAR(50) NOT NULL, number VARCHAR(255) NOT NULL, subject VARCHAR(50) NOT NULL, message LONGTEXT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE picture (id INT AUTO_INCREMENT NOT NULL, path VARCHAR(255) DEFAULT NULL, alt VARCHAR(255) NOT NULL, name VARCHAR(255) DEFAULT NULL, updated_at DATETIME DEFAULT NULL, description LONGTEXT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE translate (id INT AUTO_INCREMENT NOT NULL, yaml_key VARCHAR(255) NOT NULL, french LONGTEXT NOT NULL, turkish LONGTEXT NOT NULL, UNIQUE INDEX UNIQ_4A106377F5EBF904 (yaml_key), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
